...
<body>
    ...
    <div id='form-contain' style='margin-top:4%'>
        ...
        <form id="formulaire_update_pseudo" method="POST" action="profil_update_info.php">
            <div class="input-container">
                ...
                <input class="input-field" type="text" placeholder="Pseudo" id="pseudo_update" name="pseudo_update"
                    value="" />
            </div>
        ...
        <form id="formulaire_update_mail" method="POST" action="profil_update_info.php">
            <div class="input-container" style='margin-top:1em;'>
                ...
                <input class="input-field" type="email" placeholder="Email" id="email_update" name="email_update"
                    value="" />
            </div>
            <div class="input-container">
                <i class="fa fa-envelope icon"></i>
                <input class="input-field" type="email" placeholder="Confirmer l'email" name="email_update_confirm"
                    value="" />
            </div>
            <input id="lien_res" class="btn" type="submit" id="send_update_mail" name="send_update_mail"
                value="Modifier" />
        </form>
        <form id="formulaire_update_password" method="POST" action="profil_update_info.php">
            <div class="input-container" style='margin-top:1em;'>
                <i class="fa fa-key icon"></i>
                <input class="input-field" type="password" placeholder="Password" id="password_update"
                    name="password_update" value="" />
            </div>
            <div class="input-container">
                <i class="fa fa-key icon"></i>
                <input class="input-field" type="password" placeholder="Password" id="password_update_confirm"
                    name="password_update_confirm" value="" />
            </div>
    ...
    <footer class="page-footer font-small mdb-color lighten-3 pt-4" style="margin-top: 30em;">
        <div class="footer-copyright text-center py-3" style="color: white; margin-top: 1em;">© 2019 Copyright:Mehel-ka
        </div>
    </footer>
</body>

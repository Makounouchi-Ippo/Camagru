    ...
    <div id='form-contain'>
        ...
        <div id="formm_inscription" class="col">
            ...
            <form id="formulaire_inscription" method="POST" action="">
                ...
                <div class="input-container">
                    <i class="fa fa-key icon"></i>
                    <input class="input-field" type="password" placeholder="Confirmer le mot de passe"
                        name="password_confirm">
                </div>

                <input class="btn" type="submit" id="lien_res" name="submit" value="VALIDER!" />
                <button id="valider_incription" type="" class="btn"> <a id="lien_res"
                        href="connexion.php">CONNEXION</a></button>
                <div id="erreur">
                    <?php
                        if (isset($message))
                        {

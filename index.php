...
<body style="background-color: #222;">
    ...
    <div class="gg" style="margin-top: 4%;">
        ...
        <h2 class=""
            style="padding: 10px 16px;font-size: 18px;line-height: 1.3333333;border-radius: 6px; background-color:#337ab7;;color:white;width: 43%;text-align: center;margin: -1em auto -1em auto;">
        ...
        <div style="display: flex;">
            <a style="margin: 3% auto 1% 26%;width: 21%;" class="btn btn-primary btn-lg btn-block"
                href="view/connexion.php">Se connecter</a>
            <a style="margin: 3% auto 1% -21%;width: 21%;" class="btn btn-primary btn-lg btn-block"
                href="view/inscription.php">Inscription</a>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 mb-4">
                    <div class="view overlay z-depth-1-half">
                        <img src="https://mdbootstrap.com/img/Photos/Horizontal/Nature/4-col/img%20(78).jpg"
                            class="img-fluid" alt="">
                        <a href="">
                            <div class="mask rgba-white-light"></div>
                        </a>
                ...
                <div class="col-lg-2 col-md-12 mb-4">
                    <div class="view overlay z-depth-1-half">
                        <img src="https://mdbootstrap.com/img/Photos/Horizontal/Nature/4-col/img%20(81).jpg"
                            class="img-fluid" alt="">
                        <a href="">
                            <div class="mask rgba-white-light"></div>
                        </a>
                ...
                <div class="col-lg-2 col-md-6 mb-4">
                    <div class="view overlay z-depth-1-half">
                        <img src="https://mdbootstrap.com/img/Photos/Horizontal/Nature/4-col/img%20(84).jpg"
                            class="img-fluid" alt="">
                        <a href="">
                            <div class="mask rgba-white-light"></div>
                        </a>
